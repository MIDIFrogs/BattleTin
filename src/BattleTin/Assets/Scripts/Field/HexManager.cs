...
namespace MIDIFrogs.BattleTin.Field
{
    public class HexSelectionManager : MonoBehaviour
    {
        ...
        void SelectUnit(PieceView unit, Hex hex)
        {
            ...
            hex.GetComponent<Button3DHighlight>().Select(); // Ïîäñâåòèëè ãåêñ ïîä ôèãóðêîé
                                                            // Ìîæíî äîáàâèòü ýôôåêò íà ñàìó ôèãóðêó
        ...
        void MoveUnitToHex(Hex targetHex)
        {
            ...
            currentSelectedHex.GetComponent<Button3DHighlight>().Select(); // Òåïåðü îíà âûáðàíà íà íîâîì ìåñòå
        }
